...
public class PlayerGame {
    ...
    public PlayerGame(String username, boolean aiuto1, boolean aiuto2, boolean aiuto3, boolean aiuto4, int score, boolean activePlayer,String rispostaSel,String stoppato) {
