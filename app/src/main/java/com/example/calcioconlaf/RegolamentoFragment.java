...
public class RegolamentoFragment extends Fragment {
    ...
    public void show(){
        ...
        regText.setText("L'applicazione CalcioConLaF si compone di due giochi: 'GameStadiums' e 'GameTransfers'.\n" +
                ...
                "Entrambi i giochi sono caratterizzati da 15 domande che variano da partita a partita ma che sono uguali per tutti gli utenti in gioco.\n" +
